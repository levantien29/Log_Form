...
@AnalyzeClasses(packagesOf = ClassRoomServiceApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(ClassRoomServiceApp.class), alwaysTrue())
